...
object FakeNetwork1 {
    fun getFakeOrderDetail(callback: (orderDetail: OrderDetail1) -> Unit) {
        Handler(Looper.getMainLooper()).postDelayed({
            callback.invoke(createFakeOrderDetail())
        }, 2000)
    }

    private fun createFakeOrderDetail(): OrderDetail1 {
        ...
        return Gson().fromJson(fakeJson, OrderDetail1::class.java)
